...
test('custom types', async () => {
  await db.query(sql_1.default`CREATE SCHEMA custom_types`);
  await db.query(sql_1.default`
    ...
    `);
  const [parseNumeric, parseCurrency, parseText] = await Promise.all([db.getTypeParser('numeric'), db.getTypeParser('custom_types.currency'), db.getTypeParser('TEXT')]);
  ...
  `);
  expect(await db.query(sql_1.default`
